...
ax1.plot(reference_orbit.real, reference_orbit.imag, '--', color='black',
         label="reference")
ax1.plot(unpeturbed_rel.real, unpeturbed_rel.imag, color='blue',
         label="relativistic")
ax1.plot(rel_orbits[0].real, rel_orbits[0].imag, color='red',
         label="perturbed")
ax1.plot(basis_reconstruction[0].real, basis_reconstruction[0].imag,
         color='magenta', label="filtered")
ax1.set_xlabel('Position in geometrized units')
#ax1.set_ylabel('y')
plt.legend()
plt.show()
